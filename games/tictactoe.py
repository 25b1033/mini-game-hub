...
class TicTactoe(Gamebase):
    ...
    def check_win(self):
        t=self.board
        row = t[:,0:6] + t[:,1:7] + t[:,2:8] + t[:,3:9] + t[:,4:10]
        col = t[0:6,:] + t[1:7,:] + t[2:8,:] + t[3:9,:] + t[4:10,:]
        diag1= t[0:6,0:6] + t[1:7,1:7] + t[2:8,2:8] + t[3:9,3:9] + t[4:10,4:10]
        diag2= t[4:10,0:6] + t[3:9,1:7] + t[2:8,2:8] + t[1:7,3:9] + t[0:6,4:10]
